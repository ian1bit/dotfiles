...
if (isChild || isOld) {
  priceMessage = 'Para voce, a entrada e gratis!'
} else {
  priceMessage = 'A entrada e R$ 30,00.'
}
...
console.log(`Numeros ímpares: ${oddNumbers.join(', ').replace(', 3', ' e 3')}. Números pares: XX, XX e XX.`)
