...
console.log(isItemIncluded('esquilo', animals));
...
console.log(concatArrays(shirtIsBeuatiful, buyToMe))
...
console.log(removeLastItem(series));
...
const getLikesMessage = (names = []) => {
  ...
  switch (names.length) {
    ...
    case 2:
      return `${firstName} e ${names[1]} curtiram isso`
    case 3:
      return `${firstName}, ${names[1]} e ${names[2]} curtiram isso`
    default:
      return `${firstName}, ${names[1]} e mais ${names.length - 2} pessoas curtiram isso`
  }
}

console.log(getLikesMessage(['Ian', 'Maria', 'Gabriela', 'Joao', 'Eduarda']));