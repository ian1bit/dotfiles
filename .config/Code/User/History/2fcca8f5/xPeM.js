...
for (let i = 0; randomValues.length > i; i++) {
  ...
  if (typeof randomValues[i] === 'string') {
    stringsAmount++
    firstFourStings.push(randomValues[i])
  }
...
const lastItem = firstFourStings[firstFourStings.length - 1]

console.log(`3 informações sobre o array randomValues:
  - As primeiras 4 strings são ${firstFourStings.join(', ').replace(`, ${lastItem}`, ` e ${lastItem}`)};
