...
liNumbers.forEach(liNumber => {
  if (liNumber.innerText % 2 === 0) {
    liNumber.style.color = 'lightblue'
  }

  if (liNumber.innerText % 2 === 1) {
    liNumber.style.color = 'pink'
  }
})
...
body.classList.remove('body-backgroud')
