...
#include "/home/ianbit/.config/dwm/themes/gruvbox.h"
...
static const char *fonts[] = {
    "Martian Mono:size=10:autohint=true:antialias=true",
    "3270NerdFont:pixelsize=17:antialias=true:autohint=true"};
...
static const char *fffcmd[] = {"kitty", "-e", "ranger"};
static const char *htcmd[] = {"kitty", "-e", "htop"};
